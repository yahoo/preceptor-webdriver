...

	{
		...
		_setup: function () {
			...
			return server.setup(client.getCapabilities()).then(function () {
				...
				if (capabilities.browserName || capabilities.browser) {
					id.push(capabilities.browserName || capabilities.browser);
				}
				if (capabilities.browserVersion || capabilities.version) {
					id.push(capabilities.browserVersion || capabilities.version);
				}
				if (capabilities.platform) {
					id.push(capabilities.platform);
				}
